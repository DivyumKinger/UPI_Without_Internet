...
public class PaymentInstruction {
    ...
    // For Offline Receiver Confirmation (Local Trust)
    private String senderPublicKey; // Base64 encoded RSA public key
    private String senderSignature; // Base64 encoded signature over critical fields
