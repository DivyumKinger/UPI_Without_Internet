...
public class HybridCryptoService {
    ...
    /** Generate an RSA KeyPair for a simulated device */
    ...
    /** Sign a payload using the sender's private key */
    public String sign(String payload, PrivateKey privateKey) throws Exception {
    ...
    /** Verify a signature using the sender's public key (from base64) */
    public boolean verifySignature(String payload, String base64Signature, String base64PublicKey) throws Exception {
